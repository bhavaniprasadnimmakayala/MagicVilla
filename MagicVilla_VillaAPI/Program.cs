...
builder.Services.AddSwaggerGen(options => {
    ...
    options.SwaggerDoc("v1", new OpenApiInfo
    {
        ...
        TermsOfService = new Uri("https://templatelab.com/file/101637/?tmstv=1676461961"),
        Contact = new OpenApiContact
        {
            Name = "Dotmastery",
            Url = new Uri("https://templatelab.com/file/101645/?tmstv=1676461961")
        },
        License = new OpenApiLicense
        {
            Name = "License",
            Url = new Uri("https://templatelab.com/place-setting/")
        }
